      ...
      >
        <div className="grid grid-cols-12 xl:gap-24 gap-6 gap-y-11 items-center">
          ...
          <div className="lg:col-span-6 col-span-12 px-3">
            <motion.div {...leftAnimation}>
              <Image
                src="/images/charity-features/banner.jpg"
                alt="Charity Image"
                width={550}
                height={700}
          ...
          <div className="lg:col-span-6 col-span-12 px-3">
            <motion.div {...rightAnimation}>
              ...
              <h3 className="md:text-5xl sm:text-4xl text-3xl font-semibold text-dark dark:text-white pb-8">
                Our Core Values & Impact
              </h3>
              <ul>
                <li className="flex gap-3 items-start pb-6">
                  <span>
                    <Icon
                      icon="tabler:circle-check"
                      width="28"
                  ...
                  <p className="text-lg text-black/70 dark:text-white/70">
                    100% Transparent Donations – Know exactly where your
                    contribution goes.
                  </p>
                </li>
                <li className="flex gap-3 items-start pb-6">
                  ...
                  <p className="text-lg text-black/70 dark:text-white/70">
                    Global Outreach – Helping communities across regions and
                    borders.
                  </p>
                </li>
                <li className="flex gap-3 items-start pb-6">
                  ...
                  <p className="text-lg text-black/70 dark:text-white/70">
                    Empowering People – Supporting education, health, and
                ...
                <li className="flex gap-3 items-start">
                  ...
                  <p className="text-lg text-black/70 dark:text-white/70">
                    Dedicated Support – Our team is always ready to answer your
                    questions.
                  </p>
                </li>
              </ul>
              <div className="mt-8">
                <Link
                  href="/donate"
                  className="py-2 px-4 bg-primary rounded-lg hover:bg-orange-600 duration-300 text-white font-semibold block w-fit"
                >
                  Donate Now
                </Link>
              </div>
